...
export default function Sidebar({ showNavMobile, handleToggleNav }) {
  ...
  const { count, isPending } = usePendingOrdersCount();

  return (
    <aside
      className={`fixed top-0 left-0 h-full w-64 bg-white border-r border-slate-200 flex flex-col transform ${showNavMobile ? "translate-x-0" : "-translate-x-full md:translate-x-0"
