    ...
    <section className="space-y-6">
      ...
      <div className="flex flex-col xl:flex-row gap-4">
        ...
        <div className="xl:w-1/3 rounded-2xl shadow-lg shadow-gray-100 bg-white px-5 py-4">
          <p className="mb-3 text-2xl font-medium">Order Information</p>
          ...
          <div className="grid grid-cols-3 gap-3 mt-4">
            <div className="flex items-center justify-center gap-1">
              ...
              <p className="text-xs leading-tight text-gray-500">Shipped</p>
            </div>
            <div className="flex items-center justify-center gap-1">
              <span className="inline-block h-3 w-3 bg-blue-500 rounded-sm"></span>
              <p className="text-xs leading-tight text-gray-500">Delivered</p>
            </div>
            <div className="flex items-center justify-center gap-1">
              <span className="inline-block h-3 w-3 bg-rose-500 rounded-sm"></span>
              <p className="text-xs leading-tight text-gray-500">Return</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="rounded-2xl shadow-lg shadow-gray-100 bg-white px-5 py-4">
        <p className="mb-3 text-2xl font-medium">Pending Orders</p>
